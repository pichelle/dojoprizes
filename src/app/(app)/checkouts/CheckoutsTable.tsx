        ...
        <span className="flex items-center gap-1">
          ...
          <span className="inline-flex flex-col leading-none">
            <Tooltip label={ascLabel}>
              <button
                type="button"
                onClick={() => setSort(sortKeyName, "asc")}
            ...
            <Tooltip label={descLabel}>
              <button
                type="button"
                onClick={() => setSort(sortKeyName, "desc")}
      ...
      <div className="bg-card border border-border-warm rounded-xl overflow-hidden">
        <table className="w-full text-sm">
          <thead className="bg-nav text-left">
            <tr>
              <SortHeader label="Date" sortKeyName="date" ascLabel="Oldest" descLabel="Most recent" />
              <SortHeader label="Item" sortKeyName="item" ascLabel="A–Z" descLabel="Z–A" />
              <th className="px-3 py-2.5 font-medium text-muted text-xs">Who</th>
              <SortHeader label="Size" sortKeyName="size" ascLabel="Small to large" descLabel="Large to small" />
              <th className="px-3 py-2.5 font-medium text-muted text-xs">Color</th>
              <SortHeader label="Price" sortKeyName="price" ascLabel="Low to high" descLabel="High to low" />
